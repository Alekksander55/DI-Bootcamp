...
const getCarHonda = (carInventory) => {
  const firstCarHonda = carInventory.find((car) => car.car_make == 'Honda')
  return `This is a ${carInventory[2].car_make} ${carInventory[2].car_model} from ${carInventory[2].car_year}` 
}
